// Lifted from https://github.com/rustwasm/wasm-bindgen/blob/master/examples/raytrace-parallel/src/lib.rs
...
macro_rules! console_log {
    ($($t:tt)*) => (crate::wasm_parallel::log(&format_args!($($t)*).to_string()))
}
